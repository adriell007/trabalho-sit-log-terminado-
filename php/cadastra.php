...
if(isset($_POST['submit']))
{
    ...
    $check_user_query = mysqli_query($conexao, "SELECT * FROM cadastro WHERE email = '$email'");
        ...
        <div class="toggle-container">
            <div class="toggle">
                <div class="toggle-panel toggle-left">
                    <h1>Bem-vindo</h1>
                    <p>Faça seu cadastro para ter a melhor experiência.</p>
